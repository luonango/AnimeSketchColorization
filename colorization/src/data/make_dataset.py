    ...
    with h5py.File(hdf5_file, "w") as hfw:
        ...
        for dset_type in ["train", "test", "val"]:
            ...
            data_sketch = hfw.create_dataset("%s_data_sketch" % dset_type,
                                             ...
                                             maxshape=(None, 3, size, size),
                                             dtype=np.uint8)
            print('list_img len: ', len(list_img))
...
if __name__ == '__main__':
    ...
    parser.add_argument('--do_plot', type=bool,  # action="store_true",
...
# python make_dataset.py /home/luo/Code/PycharmProjects/AnimeSketchColorization/colorization/datasets/anime_sketch/ 3 --img_size 256 --do_plot False
